    ...
    async function menuMoresearch(searched) {
      ...
      console.log(searchNumber);
          ...
          <div class="details"> <font color="purple">
            <h3>Say "scroll down" to move down the page, if you need to.</font><font color="Red">Just say "reload" if you would like to start again.</font> </h3>
         </p>
          </div>`
          response2.data[0]
